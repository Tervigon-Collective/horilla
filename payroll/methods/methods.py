...
def monthly_computation(employee, wage, start_date, end_date, *args, **kwargs):
    ...
    # Partial deduction for custom payment_type leaves (tracked separately for
    # payslip display). Same math as before, now via the shared helper so the
    # per-type breakdown is produced too.
